...
<head>
    ...
    <title>Talking Keg Analytics</title>
...
<body onload="addTitle()">
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			Sun King Brewery<br>Logged in as Eric  <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
			<li><a>Enterprise Level Account</a>
			</li>
			<li><a>Tracking up to 10000 kegs</a>
			</li>
			<li><a>Across 5 locations</a>
			</li>
