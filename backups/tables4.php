...
<!-- 5/5/17-Editing out the supplied content
     To create our own content
     Based on MySQL Connection -nc -->
...
<!--
       ...
       -->                 <!-- /.panel-body -->
            ...
            <!-- /.row -->
<!-- Actually let's just edit out all of this
    Don't need it! nc 5/5/17
                                        <tr>
-->
    </div>
    <!-- /#wrapper -->
