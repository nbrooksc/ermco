            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                      Sun King Brewery<br>Enterprise Account<br>Tracking up to 10000 kegs<br>Across five locations<br>
			Logged in as Eric  <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
